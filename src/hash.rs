//! Lightweight SHA-256 and HMAC-SHA256 toy implementations.
...
impl Sha256 {
    ...
    pub fn finalize(mut self) -> [u8; 32] {
        ...
        self.buffer.extend_from_slice(&self.total_len.to_be_bytes());

        for chunk in self.buffer.chunks(64) {
            let chunk_arr: [u8; 64] = chunk.try_into().unwrap();
            self.process_chunk(&chunk_arr);
        }
